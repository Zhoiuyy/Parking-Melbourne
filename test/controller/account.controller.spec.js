    ...
    describe('getAccountByUsername', function() {
        context('test without arguments', function(){
            it('getAccountByUsername() should throw an error', function(){
                ...
                }).to.equal(AssertionError, 'No user has been found using this username')
            })

            
        })
        context('test with arguments', function(){
            // it('getAccountByUsername() should return zhangxiyan account', function(){
            //     var req = 'zhangxiyan';
            //     var acc = accountController.getAccountByUsername(req);
            //     var Username = acc.parms.username;
            //     expect(Username).to.equal('zhangxiyan');
            // });

            // it('getAccountByUsername() should return the correct account', function(){
