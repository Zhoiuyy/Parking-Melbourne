...
Currently Availble Functionalties:  

You can always return to the home page by clicking  "Easiparking" at the top left corner.  

These interface(1, 2, 3) you can browse without logging in  

1. Account Sign-up:  
By pressing sign up button on the top right corner.  
...
Sample account for testing: Username:zhangxiyan Password:zhangxiyan  
