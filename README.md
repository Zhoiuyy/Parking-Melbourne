...
By pressing the sign up button on the top right corner of the home page.  
...
When the user signing up, the system will detect if the username has been used by other users, if so, it will display an error message and the user will have to sign up using a different username.   
...
By pressing the log in button on the top right corner.  
...
Functionality 2:   
Account Management -  This allows user to view their account information and update informations, users can submit feedbacks.

4. Account overview  
URL: https://easiparking.herokuapp.com/account/:username  
After logging into the account.   
User can enter the overview page which includes information of himself by clicking the username at the top right corner.  
...
After clicking the parking history button on user's overview page, the user will be redirected to the page where it displays the parking history of the current user. It will display the basic information of each parking in a table form.  
...
Click the 'Find Car Park' on the middle bar, user can overview the parking information of the Melbourne city,  find a suitable parking bay from the map, enter the parking bay ID and press 'Start Parking' to start, the parking status will be recorded.  
...
After entering the parking bay, you've started parking now.  
You can view your parking status by clicking the 'parking' button at the top right corner. You can manage your parking status here, there is a button 'End Parking And Pay' to click below.  
...
There are 6 tests  
For sign up  
1. Check if we can create an account with an existing username  
All username should be unique, will receive status code 400  

2. Check if we can create an account with a valid input  
Will receive status code 200  

For account overview  

3. Check if we can get a nonexistent account   
Can not find a nonexistent account in the database, will receive status code 400  

4. Check if we can get an account by a valid username   
Will receive status code 200  

For account update  

5. Check if we can update a nonexistent account  
Can not find a nonexistent account in the database, will receive status code 400  
